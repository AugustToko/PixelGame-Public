...
namespace PixelGameAssets.Tilemap.Brushes.Random_Brush.Scripts.Editor
{
    ...
    public class RandomBrush : GridBrush 
	{
        ...
        public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
			if (randomTiles != null && randomTiles.Length > 0)
			{
				...
				var tilemap = brushTarget.GetComponent<UnityEngine.Tilemaps.Tilemap>();
				if (tilemap == null)
					return;
    ...
    public class RandomBrushEditor : GridBrushEditor
    {
		...
		public override void ClearPreview()
		{
			...
			{
				var tilemap = lastBrushTarget.GetComponent<UnityEngine.Tilemaps.Tilemap>();
				if (tilemap == null)
					return;
